...
1. **[Основные источники]** Топ бесплатные + Китайский архив + extra_urls (без расширенных)
...
5. **Только из расширенных списков поиска** (`extended_sources.txt`)
6. **Только логин и сохранение cookies**
7. **Dry-run** (проверка без добавления в аккаунт)
