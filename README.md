...
| `--tg-auto-proxy` | Самому найти рабочий прокси из общего списка и запомнить его |
...
| Способ | Как |
|---|---|
| **Автоподбор прокси** (рекомендую) | Пункт **T** в `run.bat`, ответ `A`. Или ключ `--tg-auto-proxy` |
| Свой прокси | `--tg-proxy socks5://127.0.0.1:1080` |
